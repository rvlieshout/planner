...
namespace Planner.Infrastructure.Migrations
{
    ...
    [Migration("20260827153644_InitialSchema")]
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Issue", b =>
                {
                    ...
                    b.HasIndex("TeamId", "StateId", "SortOrder")
                        .HasDatabaseName("ix_issues_team_id_state_id_sort_order");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.Milestone", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "SortOrder")
                        .HasDatabaseName("ix_milestones_project_id_sort_order");
            ...
            modelBuilder.Entity("Planner.Domain.Entities.WorkflowState", b =>
                {
                    ...
                    b.HasIndex("TeamId", "Position")
                        .HasDatabaseName("ix_workflow_states_team_id_position");
