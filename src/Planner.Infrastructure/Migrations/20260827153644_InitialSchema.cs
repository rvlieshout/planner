        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_workflow_states_teams_team_id",
                        column: x => x.team_id,
                        principalTable: "teams",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_documents_users_updated_by_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "fk_issues_users_creator_id",
                        column: x => x.creator_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_issues_workflow_states_state_id",
                        column: x => x.state_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_issue_relations_issues_source_issue_id",
                        column: x => x.source_issue_id,
                        principalTable: "issues",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_issue_relations_issues_target_issue_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_activity_events_issue_id_created_at",
                table: "activity_events",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_activity_events_team_id_created_at",
                table: "activity_events",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_documents_team_id_title",
                table: "documents",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_documents_updated_by_id",
                table: "documents",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_issue_relations_source_issue_id_target_issue_id_type",
                table: "issue_relations",
                columns: new[] { "source_issue_id", "target_issue_id", "type" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_issue_relations_target_issue_id",
                table: "issue_relations",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_issues_team_id_number",
                table: "issues",
                columns: new[] { "team_id", "number" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_projects_target_date",
                table: "projects",
                column: "target_date");

            migrationBuilder.CreateIndex(
                name: "ix_projects_team_id_name",
                table: "projects",
                columns: new[] { "team_id", "name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_projects_team_id_status",
                table: "projects",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_workflow_states_team_id_name",
